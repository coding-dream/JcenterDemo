package org.live.baselib.rvmore.ptr;
...
import org.live.baselib.rvmore.ptr.indicator.PtrIndicator;
...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private final static String KEY_SharedPreferences = "ptr_classic_last_update";
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.nn_ptr_classic_default_header, this);
