 ...
 * #setStartEndTrim(float, float)} method. MyCircularProgressDrawable also supports adding an arrow
 ...
 * methods, MyCircularProgressDrawable will fill the bounds set via {@link #setBounds(Rect)}.
 */
public class MyCircularProgressDrawable extends Drawable implements Animatable {
     ...
     */
    public MyCircularProgressDrawable(Context context) {
    ...
    /**
     * A private class to do all the drawing of MyCircularProgressDrawable, which includes background,
