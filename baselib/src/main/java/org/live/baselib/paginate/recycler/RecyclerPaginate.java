...
public final class RecyclerPaginate extends Paginate {
    ...
    public static class Builder {
         ...
         * @return {@link com.nono.android.common.paginate.recycler.RecyclerPaginate.Builder}
         * @see {@link com.nono.android.common.paginate.Paginate.Callbacks#hasLoadedAllItems()}
         * @see {@link com.nono.android.common.paginate.recycler.RecyclerPaginate.Builder#setLoadingListItemCreator(LoadingListItemCreator)}
         */
        ...
        public Paginate build() {
            ...
            return new RecyclerPaginate(recyclerView, callbacks, loadingTriggerThreshold, addLoadingListItem,
                    loadingListItemCreator, loadingListItemSpanLookup, onScrollListener);
        }
    }
